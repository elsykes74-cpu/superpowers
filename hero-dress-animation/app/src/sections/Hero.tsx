...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* Left: golden WebGL shader */}
      <div
        ref={canvasHostRef}
        style={{ position: 'relative', width: '100%', minHeight: '420px', overflow: 'hidden' }}
      >
        <canvas
          ref={canvasRef}
        ...
        >
          {/* Gold accent rule */}
          <div style={{ width: '40px', height: '1px', backgroundColor: '#C9A96E', marginBottom: '20px' }} />
          <h2
            style={{
      ...
      >
        <div style={{ maxWidth: '520px', width: '100%', marginLeft: 'auto', marginRight: 'auto' }}>
          ...
          {submitted ? (
            ...
            >
              <div style={{ width: '32px', height: '1px', backgroundColor: '#C9A96E', marginBottom: '20px' }} />
...
function TextareaField({ label, name, placeholder, value, onChange }: {
  ...
  return (
    <label style={{ display: 'block' }}>
      <span style={labelBase}>{label}</span>
      <textarea
        name={name} placeholder={placeholder} rows={3} value={value} onChange={onChange}
