  ...
  return (
    <header
      style={{
        ...
        transition:
          'height 0.45s cubic-bezier(0.16, 1, 0.3, 1), background-color 0.4s ease, border-color 0.4s ease, backdrop-filter 0.4s ease',
      }}
    >
      {/* Logo wordmark */}
      <div
  ...
  return (
    <button
      ...
      style={{
        ...
        color: overHero
          ? (hovered ? '#ffffff' : 'rgba(255,255,255,0.82)')
          : (hovered ? '#000000' : 'rgba(0,0,0,0.72)'),
