...
export default function Capabilities() {
  ...
  useEffect(() => {
    ...
    if (!img) return
    // Image is loaded via src, no play needed
  }, [])
    ...
    >
      ...
      <div
        style={{
          position: 'absolute',
          inset: 0,
          background: 'linear-gradient(135deg, rgba(201,169,110,0.04) 0%, transparent 40%, rgba(80,60,120,0.06) 100%)',
          zIndex: 1,
        }}
      />
        ...
        >
          <div style={{ flex: '1 1 500px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '20px' }}>
              <span style={{ display: 'block', width: '24px', height: '1px', backgroundColor: '#C9A96E' }} />
              <p
                style={{
...
function OrbitalBadge() {
  ...
  useEffect(() => {
    ...
    textEl.setAttribute('fill', '#C9A96E')
